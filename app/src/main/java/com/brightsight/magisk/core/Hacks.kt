...
import com.brightsight.magisk.core.utils.refreshLocale
import com.brightsight.magisk.core.utils.updateConfig

fun AssetManager.addAssetPath(path: String) {
    com.brightsight.magisk.DynAPK.addAssetPath(this, path)
}
...
object AssetHack {
    ...
    fun init(context: Context) {
        ...
        refreshLocale()
        if (isRunningAsStub) {
            apk = com.brightsight.magisk.DynAPK.current(context).path
