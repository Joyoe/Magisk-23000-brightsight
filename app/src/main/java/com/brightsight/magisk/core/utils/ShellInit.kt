package com.brightsight.magisk.core.utils
...
import com.brightsight.magisk.ktx.cachedFile
import com.brightsight.magisk.ktx.deviceProtectedContext
import com.brightsight.magisk.ktx.rawResource
    ...
    override fun init(context: Context, shell: Shell): Boolean {
        shell.newJob().apply {
            ...
            if (isRunningAsStub) {
                if (!shell.isRoot)
                    return true
                val jar = JarFile(com.brightsight.magisk.DynAPK.current(context))
