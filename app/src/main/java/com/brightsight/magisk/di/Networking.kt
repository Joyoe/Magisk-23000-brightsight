package com.brightsight.magisk.di

import android.content.Context
import com.squareup.moshi.Moshi
import com.brightsight.magisk.BuildConfig
import com.brightsight.magisk.ProviderInstaller
import com.brightsight.magisk.core.Config
import com.brightsight.magisk.core.Info
import com.brightsight.magisk.ktx.precomputedText
import com.brightsight.magisk.utils.MarkwonImagePlugin
...
fun createOkHttpClient(context: Context): OkHttpClient {
    ...
    if (!com.brightsight.magisk.ProviderInstaller.install(context)) {
        Info.hasGMS = false
    }
