...
import com.brightsight.magisk.core.AssetHack
...
import com.brightsight.magisk.utils.DynamicClassLoader
...
inline fun <reified T> T.createClassLoader(apk: File) =
        com.brightsight.magisk.utils.DynamicClassLoader(apk, T::class.java.classLoader)
