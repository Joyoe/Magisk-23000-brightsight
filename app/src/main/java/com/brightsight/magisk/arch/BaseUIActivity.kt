package com.brightsight.magisk.arch
...
import com.brightsight.magisk.ui.inflater.LayoutInflaterFactory
import com.brightsight.magisk.ui.theme.Theme

abstract class BaseUIActivity<VM : com.brightsight.magisk.arch.BaseViewModel, Binding : ViewDataBinding> :
    BaseActivity(), com.brightsight.magisk.arch.BaseUIComponent<VM> {
    ...
    protected val currentFragment get() = topFragment as? com.brightsight.magisk.arch.BaseUIFragment<*, *>
    ...
    override fun onEventDispatched(event: com.brightsight.magisk.arch.ViewEvent) = when (event) {
        is com.brightsight.magisk.arch.ContextExecutor -> event(this)
        is com.brightsight.magisk.arch.ActivityExecutor -> event(this)
        else -> Unit
    }
