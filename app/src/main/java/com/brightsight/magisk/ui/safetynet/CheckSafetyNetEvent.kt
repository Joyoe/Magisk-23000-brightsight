...
import com.brightsight.magisk.arch.ContextExecutor
import com.brightsight.magisk.arch.ViewEventWithScope
import com.brightsight.magisk.core.Const
import com.brightsight.magisk.di.ServiceLocator
import com.brightsight.magisk.ktx.createClassLoader
import com.brightsight.magisk.ktx.reflectField
import com.brightsight.magisk.ktx.writeTo
import com.brightsight.magisk.view.MagiskDialog
import com.brightsight.signing.CryptoUtils
...
class CheckSafetyNetEvent(
    ...
    private fun String.parseJws(): SafetyNetResponse {
        ...
        val cert = com.brightsight.signing.CryptoUtils.readCertificate(bis)
