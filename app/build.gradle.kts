...
android {
    defaultConfig {
        applicationId = "com.brightsight.magisk"
...
android.applicationVariants.all {
    ...
    val outSrc = File(outSrcDir, "com/brightsight/signing/KeyData.java")
    ...
    val genSrcTask = tasks.register("generate${name.capitalize()}KeyData") {
        ...
        doLast {
            ...
            PrintStream(outSrc).use {
                it.println("package com.brightsight.signing;")
...
dependencies {
    ...
    implementation(project(mapOf("path" to ":native")))
